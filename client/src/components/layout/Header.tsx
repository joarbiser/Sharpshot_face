...
export default function Header() {
  ...
  return (
    <>
      <nav className="sticky top-0 z-50 bg-white dark:bg-gray-900 border-b border-[#D8AC35] transition-colors duration-200">
          ...
          <div className="flex items-center justify-between h-16 md:h-16">
            ...
            <div className="flex items-center justify-center flex-shrink-0">
              <Link href="/" onClick={scrollToTop} className="flex items-center space-x-2 cursor-pointer py-2 px-4">
                ...
                />
                <span 
                  className="logo-text text-xl md:text-2xl font-black flex-shrink-0 uppercase tracking-wide whitespace-nowrap cursor-pointer overflow-visible pr-2 transition-all duration-150 ease-out hover:tracking-tighter" 
