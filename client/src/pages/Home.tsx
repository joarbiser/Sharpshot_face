          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            ...
            <div className="flex-1 text-center md:text-left">
              <h1 className="text-black text-4xl md:text-6xl font-bold leading-tight mb-6">
                IT'S NOT LUCK.<br />
                IT'S <span className="text-[#C19A6B]">LEVERAGE</span>.
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                <Link href="/calculator">
                  <Button className="bg-[#C19A6B] text-black px-8 py-4 rounded-xl font-semibold text-lg hover:scale-105 hover:shadow-lg transition-all duration-300 shadow-md">
                    Estimate Your Edge
                  </Button>
                </Link>
                <Link href="/calculator">
            ...
            <div className="flex-1 max-w-md w-full">
              <div className="bg-black text-white p-6 rounded-2xl shadow-lg w-full" id="terminal">
                <div className="flex items-center justify-between mb-4 border-b border-gray-600 pb-3">
                  <div className="text-[#C19A6B] font-bold tracking-wider text-sm">SHARP SHOT TERMINAL</div>
                ...
                <div className="grid grid-cols-3 gap-4 mb-6 text-xs">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-[#C19A6B] font-bold text-lg">+4.2%</div>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center group">
              <div className="w-16 h-16 bg-gradient-to-br from-[#C19A6B]/20 to-[#C19A6B]/10 rounded-xl flex items-center justify-center mx-auto mb-6 border border-[#C19A6B]/20 group-hover:border-[#C19A6B]/40 transition-all duration-500 ease-in-out">
                <i className="fas fa-chart-line text-[#C19A6B] text-2xl"></i>
              </div>
            ...
            <div className="text-center group">
              <div className="w-16 h-16 bg-gradient-to-br from-[#C19A6B]/20 to-[#C19A6B]/10 rounded-xl flex items-center justify-center mx-auto mb-6 border border-[#C19A6B]/20 group-hover:border-[#C19A6B]/40 transition-all duration-500 ease-in-out">
                <i className="fas fa-filter text-[#C19A6B] text-2xl"></i>
              </div>
            ...
            <div className="text-center group">
              <div className="w-16 h-16 bg-gradient-to-br from-[#C19A6B]/20 to-[#C19A6B]/10 rounded-xl flex items-center justify-center mx-auto mb-6 border border-[#C19A6B]/20 group-hover:border-[#C19A6B]/40 transition-all duration-500 ease-in-out">
                <i className="fas fa-target text-[#C19A6B] text-2xl"></i>
              </div>
