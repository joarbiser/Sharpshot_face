            ...
            <div className="bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white rounded-2xl border border-gray-700 shadow-2xl overflow-hidden">
              ...
              <div className="bg-gradient-to-b from-black to-gray-900">
                {loading ? (
                  ...
                  <div className="p-10">
                    {/* Trading Grid Header */}
                    <div className="grid grid-cols-10 gap-4 text-sm font-mono uppercase tracking-wider text-gray-400 border-b border-gray-700 pb-4 mb-6">
                    ...
                    {opportunities.map((opp, index) => {
                      ...
                      return (
                        <div key={`${opp.id}-${index}`} className="grid grid-cols-10 gap-4 items-center py-5 px-4 rounded-lg border-l-4 border-l-[#00ff41] bg-gradient-to-r from-gray-900/50 to-transparent hover:from-gray-800/50 transition-all duration-300 mb-4">
                          ...
                          <div className="col-span-1">
                            <div className="flex gap-1 justify-start">
                              ...
                              <div className="flex flex-col items-center space-y-1">
                                <div className="text-xs text-gray-400 font-mono uppercase h-5 flex items-center justify-center">AVG</div>
                                <div className="bg-[#D8AC35] text-black rounded px-2 py-1 text-xs font-bold font-mono text-center min-w-12">
                              ...
                              {opp.oddsComparison.slice(1, 3).map((comp, idx) => (
                                <div key={idx} className="flex flex-col items-center space-y-1">
                                  ...
                                  <div className="bg-gray-700 border border-gray-600 text-white rounded px-2 py-1 text-xs font-mono text-center min-w-12">
