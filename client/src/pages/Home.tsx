      ...
      <section className="relative min-h-[90vh] flex items-center justify-between overflow-hidden px-8 md:px-16">
        ...
        <div className="relative z-10 flex items-center justify-between max-w-7xl mx-auto w-full">
          ...
          <div className="flex-1 text-center md:text-right">
            <h1 className="hero-glimmer text-foreground text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black leading-tight mb-6" style={{ fontFamily: "'Saira Condensed', sans-serif", fontStyle: 'italic', transform: 'skew(-5deg)' }}>
              It's not luck.<br />
