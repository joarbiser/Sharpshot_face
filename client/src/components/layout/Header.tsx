        ...
        <div className="max-w-full mx-auto px-4 md:px-8 lg:px-12">
          <div className="flex items-center justify-between h-16 md:h-16">
            ...
            <div className="flex items-center justify-center flex-shrink-0">
              <Link href="/" onClick={scrollToTop} className="flex items-center space-x-2 cursor-pointer py-2 px-4" style={{ width: 'max-content' }}>
                <img 
                  src="/logo-gold.png" 
                  alt="Sharp Shot Logo" 
                ...
                />
                <span 
                  className="logo-text text-xl md:text-2xl font-black flex-shrink-0 uppercase tracking-wide whitespace-nowrap cursor-pointer overflow-visible pr-2 transition-all duration-150 ease-out hover:tracking-tighter block" 
                  style={{ fontFamily: "'Saira Condensed', sans-serif", fontStyle: 'italic', transform: 'skew(-5deg)', minWidth: '140px', width: '140px' }}
                >
                  SHARP SHOT
                </span>
              </Link>
